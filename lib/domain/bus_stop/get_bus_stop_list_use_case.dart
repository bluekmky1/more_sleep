...
final Provider<GetBusStopListUseCase> getBusStopListUseCaseProvider =
    Provider<GetBusStopListUseCase>(
  (ProviderRef<GetBusStopListUseCase> ref) => GetBusStopListUseCase(
    supabaseClient: ref.watch(supabaseServiceProvider),
  ),
);

class GetBusStopListUseCase {
  const GetBusStopListUseCase({
